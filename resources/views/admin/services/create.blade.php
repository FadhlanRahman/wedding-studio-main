...
<div class="bg-white p-6 rounded-lg shadow-md max-w-2xl mx-auto">
    ...
    <form action="{{ route('admin.services.store') }}" 
          method="POST" 
          enctype="multipart/form-data" {{-- ✅ wajib agar file bisa diupload --}}
          class="space-y-5">
        ...
        {{-- Upload PDF --}}
        <div>
            <label for="pdf_file" class="block font-medium mb-1">Deskripsi Paket (PDF)</label>
            <input type="file" name="pdf_file" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-blue-200" accept="application/pdf">
            <p class="text-sm text-gray-500 mt-1">Upload file PDF berisi detail paket layanan.</p>
        </div>
