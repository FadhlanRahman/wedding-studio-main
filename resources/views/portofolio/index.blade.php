...
<style>
  ...
  .media-wrap img,
  .media-wrap video{ transition: transform .8s cubic-bezier(.2,.8,.2,1); }
  .card:hover .media-wrap img,
  .card:hover .media-wrap video{ transform: scale(1.03); }
  ...
  /* Pastikan tombol selalu di atas media */
  .videoSwiper .swiper-button-next,
  .videoSwiper .swiper-button-prev,
  .localVideoSwiper .swiper-button-next,
  .localVideoSwiper .swiper-button-prev{
  ...
  /* Tombol mute/unmute */
  .mute-toggle{
    position:absolute; right:.75rem; bottom:.75rem; z-index:80;
  ...
  .mute-toggle:hover{ transform: translateY(-2px); background:#fff; }
          ...
          <div class="swiper-slide">
            <article class="card overflow-hidden">
              <div class="media-wrap video-container">
                ...
                <button class="mute-toggle" type="button" aria-label="Unmute video" aria-pressed="true" data-state="muted">
                  🔇 Unmute
                </button>
              </div>
              <div class="p-5">
...
<script>
  ...
  var videoSwiper = new Swiper(".videoSwiper", {
    ...
    a11y: { enabled: true },
    keyboard: { enabled: true },
    // ⛔️ HAPUS effect:'fade' & fadeEffect agar bisa >1 slide
